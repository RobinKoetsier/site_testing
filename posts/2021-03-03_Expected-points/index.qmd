...
format:
  html:
    theme: cosmo
    toc: true
description: "How do we calculate xPoints?"
date: 2021-03-03
---
...
<br /> <br /> This post is about Expected Points
...
<br /> #### XPOINTS? What can we do with xPoints and do we need it?\
...
Besides the two goals, Groningen has a lot of medium sized chances. Twente has three good chances, but not much else. For getting the chance to win and so the expected points, we will simulate those chances. <br />
