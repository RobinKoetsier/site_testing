...
df1 <- readxl::read_excel("Export_TDL_KKD_2324.xlsx", 
                   sheet = "Wedstrijden") %>%
...
df2 <- readxl::read_excel("Export_TDL_KKD_2324.xlsx", 
                   sheet = "Wedstrijden") %>%
...
xRank <- readxl::read_excel("Export_TDL_KKD_2324.xlsx", 
                  sheet = "Stand")# %>% 
#  mutate(Form = NA)
...
div(class = "standings",
  div(class = "title",
    h2("Expected Points Eerste Divisie 2023/2024"),
...
```{=html}
<a href='Export_TDL_KKD_2324.xlsx' target="_blank">Download file</a>
